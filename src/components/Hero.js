    ...
    <section className='min-h-[980px] bg-hero bg-cover bg-right'>
      ...
      <div className='container mx-auto min-h-[980px] flex justify-center items-center '>
        ...
        <motion.div
          ...
          {/* pretitle */}
          <motion.div variants={fadeIn('down', 'tween', 0.2, 1.1)} className='text-white text-[24px] lg:text-[28px] font-primary italic lg:font-medium mb-1'>{pretitle}</motion.div>
          {/* title */}
          ...
          {/* button */}
          <motion.div variants={fadeIn('down', 'tween', 0.5, 1.1)}>   <button className='btn'>{btnText}</button> </motion.div>
      </motion.div>
        </div>
        </section>
        );
